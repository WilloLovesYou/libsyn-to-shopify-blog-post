(function() {
    ...
    Promise.all([
        ...
        for (var k = 0; k < episodes.length; k++) {
            ...
            h += '<span style="display:flex;align-items:center;gap:8px;flex-shrink:0;margin-left:12px;" onclick="toggle(this.parentElement)">';
